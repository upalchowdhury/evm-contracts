...
contract appToken is Ownable {
  ...
  string public constant name = "appToken";

  /// @notice EIP-20 token symbol for this token
  string public constant symbol = "appToken";
  ...
  uint256 public constant totalSupply = 10_000_000_000e18; // 10 billion Ondo
   ...
   * @param _owner The initial account to grant owner permission and all the tokens
   */
  constructor(address _owner) {
    balances[_owner] = uint96(totalSupply);
  ...
  /**
   * @notice Turn on _transferAllowed variable. Trasnfers are enabled
   */
